...
namespace CarParkSystem.Repository.Migrations
{
    ...
    [Migration("20230924071627_CarWashFeeAndTireChangeFee")]
    partial class CarWashFeeAndTireChangeFee
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarParkSystem.Core.Model.CarPark", b =>
                {
                    ...
                    b.Property<decimal>("TireChangeFee")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("CarParkSystem.Core.Model.FirstClassVehicleFeature", b =>
                {
                    ...
                    b.Property<int>("ParkingCoefficient")
                        .HasColumnType("int");
